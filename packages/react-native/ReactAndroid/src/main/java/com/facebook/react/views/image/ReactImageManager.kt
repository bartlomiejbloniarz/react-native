...
public constructor(
  ...
  /**
   * The legacy raw-props path delivers these props as a plain uri string, but the Props 2.0
   * diffing path (`ImageProps::getDiffProps`) serializes the full ImageSource object. Accept both
   * formats so either pipeline (and either side of a JS/native version skew) keeps working.
   */
